...
class hybridreso(ConflictResolution):
    ...
    def resumenav(self, conf, ownship, intruder):
        ...
        # Trajectory after the original conflict is finished
            ...
            if iwpid > -1:  # To avoid problems if there are no waypoints
                ...
                if traf.resostrategy[idx] == "RESO1":
                    ...
                    if not conflictProbe(ownship, intruder, idx, dtlook=dtlookdown, targetVs=vsMinOwn):
                        # Reso 1 so descend back to the cruising altitude
    ...
    # TODO: THIS IS ONLY A TEMPROARY FIX!!!
    @property
    def hdgactive(self):
    ...
    def reso1(self, idxown):
        ...
        self.altactive[idxown] = True
        self.vsactive[idxown]  = True
