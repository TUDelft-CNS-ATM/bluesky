...
class Traffic:
    ...
    def reset(self, navdb):
        ...
        self.swdecent = False # If True: when lnav is False due to lack of waypoints,vnav is false but overruled by this switch. Result is that aircraft with lnav/vnav False start to descent
