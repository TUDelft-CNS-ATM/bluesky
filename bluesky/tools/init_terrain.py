...
# NYC for debug and test
south = 40.2
west = -74.5
north = 41.5
east = -73.1
# south, west, north, east = 40.46993497635156, -74.322509765625, 40.77506339716835, -73.63105773925781
# south, west, north, east = 40.5, -73.9, 43.5, -73.6
...
opentopography_api_key = "7810346f49fe46f48049c5088bc72111"
...
class DEM():
    ...
    def __init__(self, bounding_box, reset=False):
        ...
        print("Selected angular area = ", angular_area, "deg^2.")
    ...
    def _init_interpo_DEM(self):
        ...
        for item in self.needed_list:
            ...
            # print(len(yx))
            # print(elevation.shape)  # (num_y, num_x)
            # print(len(z))
            # # print(xy)
            # print(len(x))
            # print(len(y))
        ...
        # print(len(list(zip(y, x))), len(x), len(y), len(z))
        # print(list(zip(y, x)))
...
if __name__ == "__main__":
    ...
    # print(type(terrain.interpo_terrain))
